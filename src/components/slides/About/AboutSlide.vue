...
const links = [
  { label: 'Github', url: 'https://github.com/Akasiek', description: 'a code hosting platform for version control and collaboration', iconPath: '/icons/about/github.svg' },
  {
    label: 'LinkedIn',
  ...
  { label: 'Mastodon', url: 'https://metalhead.club/@Akasiek', description: 'a free and open-source self-hosted social networking service', iconPath: '/icons/about/mastodon.svg' },
  {
    label: 'Letterboxd',
    ...
    <div class="max-w-3xl">
      ...
      <div class="flex flex-col gap-5 text-primary-gray text-lg">
        ...
        <div>
          ...
          <section class="flex gap-10 grid-cols-5 w-full mt-4">
